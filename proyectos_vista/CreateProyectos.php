            ...
            <div class="col-12 col-md-6">
                <div class="card border-primary">
                    ...
                    <div class="card-body">
                        <form action="#">
                            <div class="mb-3">
                                <label for="nombre_proyecto" class="form-label text-primary">Nombre del proyecto:</label>
                                <input type="text" name="nombre_proyecto" id="nombre_proyecto" class="form-control" placeholder="Nombre del proyecto">
                            </div>
                            <input type="text" name="nombre_p" id="nombre_p" class="form-control" placeholder="Nombre del proyecto">
                            </div>
                            <div class="mb-3">
